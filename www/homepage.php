...
<link href="jumbotron.css" rel="stylesheet">
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p><a class="btn btn-primary btn-lg" href="javascript:void(0);" onClick="vpb_show_sign_up_box();">Sign Up </a></p>
      </div>
    </div>
...
<div class="container marketing">
  ...
  <div class="row">
    <div class="col-md-4 text-center">
      ...
      <p><a class="btn btn-default" href="javascript:void(0);" onClick="vpb_show_sign_up_box();">Start Tacking »</a></p>
    </div>
    <div class="col-md-4 text-center">
      ...
      <p><a class="btn btn-default" href="javascript:void(0);" onClick="vpb_show_sign_up_box();">Start Making Boards »</a></p>
    </div>
    <div class="col-md-4 text-center">
      ...
      <br>
      <br>
      <p><a class="btn btn-default" href="javascript:void(0);" onClick="vpb_show_sign_up_box();">Start Following »</a></p>
    </div>
  </div><!-- /.row -->
