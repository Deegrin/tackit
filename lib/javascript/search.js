...
$(document).ready(function() {
    ...
    $(document).on('click', "a.retack-tack", function() {
        var board_id = $(this).data('board');
        $.ajax({
            type: "POST",
            dataType:'json',
        ...
        alert("Retack" + $(this).data("tack"));
    })
    
    $(document).on('click', "a.email-tack", function() {
                ...
                if($('#activeSearch').text() == "Tacks"){
                    ...
                    for(i = 0; i < response.data.length; i++) {
                        ...
                        for(j = 0; j < board_list.length; j++) {
                            tack_results_string += '<li><a href="#" data-board=' + board_list[j].id + ' class="retack-tack">' + board_list[j].title + '</a></li>';
                        }
